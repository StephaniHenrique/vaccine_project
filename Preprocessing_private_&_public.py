...
df_train = pd.read_csv('./Dataset/Private_dt/JM_no_standard.csv')
df_val = pd.read_csv('./Dataset/Private_dt/JM_validation_no_standard.csv')
df_jt_train = pd.read_csv('./Dataset/Private_dt/JT_no_standard.csv')   
df_jt_val = pd.read_csv('./Dataset/Private_dt/JT_validation_no_standard.csv')
df_public = pd.read_csv('./Dataset3_Apenas_Clinico.csv')
...
df_public_final = df_public_cleaned[common_features + ['Target']].copy()
...
df_standardize = pd.concat([df_train_final, df_val_final, df_JT_train_final, df_JT_val_final, df_public_final], ignore_index=True)
...
df_public_final_standard = df_standardize[df_standardize['Role_id'] == 4].drop('Role_id', axis=1)
...
pd.concat([df_JM_train_final_standard, df_JT_train_final_standard, df_JM_val_final_standard, df_JT_val_final_standard], ignore_index=True).to_csv('TRAIN_combo_j&j_standard_CLINICO.csv', index=False)
df_public_final_standard.to_csv('FCS_PUBLIC_final_standard_CLINICO.csv', index=False)
