...
df_public_multiple = pd.read_csv('./dataset_virus_encoded.csv')
...
df_standardize_multiple[fc_features_multiple] = discretizador_multiple.fit_transform(df_standardize_multiple[fc_features_multiple]).astype(int)
...
df_standardize_multiple.to_csv('multiple_arcsinh.csv', index=False)
